function ovn_victory_conditions()
	...
	--		}
		...
		elseif cm:get_faction("wh2_main_wef_treeblood"):is_human() then
			...
			cm:trigger_custom_mission_from_string("wh2_main_wef_treeblood", mission[1]);
			cm:trigger_custom_mission_from_string("wh2_main_wef_treeblood", mission[2]);
		...
		elseif cm:get_faction("wh_dlc08_nor_naglfarlings"):is_human() then
			...
			cm:trigger_custom_mission_from_string("wh_dlc08_nor_naglfarlings", mission[1]);
			cm:trigger_custom_mission_from_string("wh_dlc08_nor_naglfarlings", mission[2]);
