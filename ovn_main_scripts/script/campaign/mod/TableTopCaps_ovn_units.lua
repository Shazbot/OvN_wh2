...
local ovn_all_loaned_units = {
    ...
    {"wh_main_chs_inf_chaos_warriors_0", "wh_main_sc_emp_araby", "arb_core"},
    {"wh_dlc06_chs_inf_aspiring_champions_0", "wh_main_sc_emp_araby", "arb_special", 1},
    {"wh_main_chs_cav_chaos_knights_0", "wh_main_sc_emp_araby", "arb_special", 2},
    {"wh_main_chs_mon_chaos_spawn", "wh_main_sc_emp_araby", "arb_rare", 1},
    {"wh2_dlc09_tmb_veh_skeleton_chariot_0", "wh_main_sc_emp_araby", "arb_core"},
    {"wh2_dlc09_tmb_inf_nehekhara_warriors_0", "wh_main_sc_emp_araby", "arb_core"},
    {"wh2_dlc09_tmb_inf_tomb_guard_1", "wh_main_sc_emp_araby", "arb_special", 1},
    ...
    {"wh_dlc08_nor_mon_frost_wyrm_0", "wh_main_sc_nor_fimir", "fim_rare", 3},
    ...
    {"wh_pro04_chs_mon_chaos_spawn_ror_0", "wh_main_sc_nor_fimir", "fim_rare", 1},

    {"wh_dlc08_nor_inf_marauder_hunters_1", "wh_main_sc_nor_fimir", "fim_core"},
    ...
    {"wh_main_chs_mon_chaos_spawn", "wh_main_sc_nor_fimir", "fim_rare", 1},
    ...
    {"wh2_main_hef_mon_great_eagle", "wh_main_sc_emp_empire", "emp_special", 2},
    ...
    {"wh_dlc08_nor_inf_marauder_hunters_1", "wh_main_sc_nor_warp", "wrp_core"},
    {"wh_main_nor_cav_marauder_horsemen_1", "wh_main_sc_nor_warp", "wrp_core"},
    {"wh_dlc08_nor_mon_warwolves_0", "wh_main_sc_nor_warp", "wrp_special", 1},
    {"wh_main_nor_mon_chaos_trolls", "wh_main_sc_nor_warp", "wrp_special", 2},
    {"wh_dlc08_nor_mon_norscan_ice_trolls_0", "wh_main_sc_nor_warp", "wrp_special", 2},
    {"wh_dlc08_nor_cav_marauder_horsemasters_0", "wh_main_sc_nor_warp", "wrp_core"},
    {"wh_dlc08_nor_mon_frost_wyrm_0", "wh_main_sc_nor_warp", "wrp_rare", 3},
    ...
    {"wh_dlc06_chs_inf_aspiring_champions_0", "wh_main_sc_nor_warp", "wrp_special", 1},
    ...
    {"wh_dlc01_chs_mon_dragon_ogre_shaggoth", "wh_main_sc_nor_warp", "wrp_rare", 3},
    {"wh_main_chs_mon_chaos_spawn", "wh_main_sc_nor_warp", "wrp_rare", 1},
    ...
    {"wh2_main_skv_inf_stormvermin_1", "wh_main_sc_nor_warp", "wrp_special", 1},
    {"wh2_main_skv_mon_rat_ogres", "wh_main_sc_nor_warp", "wrp_special", 2},

    {"wh2_main_skv_inf_death_globe_bombardiers", "wh_main_sc_nor_warp", "wrp_rare", 1},
    {"wh2_dlc12_skv_inf_ratling_gun_0", "wh_main_sc_nor_warp", "wrp_special", 1},
    {"wh2_main_skv_inf_warpfire_thrower", "wh_main_sc_nor_warp", "wrp_special", 1},
    ...
    {"wh2_dlc14_skv_inf_eshin_triads_0", "wh_main_sc_nor_warp", "wrp_special", 1},
    {"wh2_dlc14_skv_inf_poison_wind_mortar_0", "wh_main_sc_nor_warp", "wrp_special", 2},
    {"wh2_dlc14_skv_inf_warp_grinder_0", "wh_main_sc_nor_warp", "wrp_special", 1},
    ...
    {"wh2_main_skv_inf_death_runners_0", "wh_main_sc_nor_warp", "wrp_special", 1},
    ...
    {"wh2_main_skv_inf_poison_wind_globadiers", "wh_main_sc_nor_warp", "wrp_special", 2},
    {"wh2_main_skv_mon_hell_pit_abomination", "wh_main_sc_nor_warp", "wrp_rare", 3},
    {"wh2_main_skv_veh_doomwheel", "wh_main_sc_nor_warp", "wrp_rare", 2},
    {"wh2_dlc16_skv_mon_brood_horror_0", "wh_main_sc_nor_warp", "wrp_rare", 2},
    {"wh2_dlc16_skv_mon_rat_ogre_mutant", "wh_main_sc_nor_warp", "wrp_special", 3},

    ---------------------------------------------------------------
    --TROLLS
    ---------------------------------------------------------------

    {"wh_dlc08_nor_mon_norscan_ice_trolls_0", "wh_main_sc_nor_troll", "trl_special", 2},
    {"wh_main_chs_mon_trolls", "wh_main_sc_nor_troll", "trl_special", 1},
    {"wh_main_nor_mon_chaos_trolls", "wh_main_sc_nor_troll", "trl_special", 2},
    {"wh_main_grn_mon_trolls", "wh_main_sc_nor_troll", "trl_special", 1},
    {"wh_dlc01_chs_mon_trolls_1", "wh_main_sc_nor_troll", "trl_special", 1}

}--:vector<{string, string, string, number?}>

if not not rm then
    rm:add_units_in_table_to_tabletop_groups(ovn_all_units)
    rm:add_loaned_units_in_table(ovn_all_loaned_units)
end
