...
local function apply_diplo_bonuses()
	...
	cm:apply_dilemma_diplomatic_bonus("wh2_main_arb_aswad_scythans", "wh2_main_skv_clan_mors", 3)
...
local function albion_setup()
	...
	if albion and (albion:is_human() or not mct or settings_table.albion and settings_table.enable) then
		...
		end		local is_durak_starting_lord = core:svr_load_bool("ovn_albion_dural_durak_is_leader")
